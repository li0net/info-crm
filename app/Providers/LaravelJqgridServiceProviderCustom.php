...
class LaravelJqgridServiceProviderCustom extends ServiceProvider {
    ...
    public function boot()
    {
        ...
        {
            $this->publishes([
                __DIR__ . '/../../vendor/mgallegos/laravel-jqgrid/src/config/config.php' => config_path('laravel-jqgrid.php'),
            ]);

            $this->mergeConfigFrom(
                __DIR__ . '/../../vendor/mgallegos/laravel-jqgrid/src/config/config.php', 'laravel-jqgrid'
            );
        }
    }
    ...
    public function registerEncoder()
    {
        ...
        $this->app->bind('App\Libraries\RequestedDataInterfaceCustom', function($app)
        {
            //return new Encoders\JqGridJsonEncoder($app->make('excel'));
            return new \App\Libraries\jqGridJsonEncoderCustom($app->make('excel'));
        });
    }

...
return [
    ...
    */
    ...
    'widget:division_head'                  => 'Elegir división',
    'widget:online_registration'            => 'Registro online',
    'widget:employee_head'                  => 'Elegir empleado',
    'widget:service_head'                   => 'Elegir servicio',
    'widget:time_head'                      => 'Elige el tiempo',
    'widget:form_head'                      => 'Ingrese sus datos',
    'widget:category_head'                  => 'Elegir categoría de servicio',
    'widget:day_head'                       => 'Elegir fecha',
    'widget:employee_doesnot_matter_text'   => 'El empleado no importa',
    'widget:name'                           => 'Tu nombre',
    'widget:7_phone'                        => '+7 teléfono',
    'widget:comment'                        => 'Comentario',
    'widget:remind_me'                      => 'Recuerdame',
    'widget:hour'                           => 'hora',
    'widget:hours'                          => 'Horas',
    'widget:day'                            => 'día',
    'widget:i_agree'                        => 'Estoy de acuerdo con la',
    'widget:terms_conditions'               => 'Términos de uso y política de privacidad',
    'widget:send'                           => 'Enviar',
    'widget:duration'                       => 'duración',
    'widget:info'                           => 'Información',
    'widget:contacts'                       => 'Contactos',
    'widget:phone'                          => 'Teléfono',
    'widget:address'                        => 'Dirección',
    'widget:work_hours'                     => 'Horas laborales',

    'employee:sync_wage_schemes_error_message'      => 'Error al sincronizar el esquema de cálculo de salarios. Informe sobre este error a su administrador.',
    'employee:sync_wage_schemes_success_message'    => 'Esquema de cálculo de salario guardado con éxito.',
    'employee:wage_scheme_label'                    => 'Esquema salarial',
    'employee:wage_scheme_start_from_label'         => 'Válida desde',

    'calculated_wage:grid_pay_link'                 => 'Paga',
];

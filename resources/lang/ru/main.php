...
return [
    ...
    */
    ...
    'user:btn_update_phone'                 => 'Изменить номер',
    ...
    'widget:remind_me'                      => 'Напомнить мне',
    'widget:hour'                           => 'час',
    'widget:hours'                          => 'часа(ов)',
    'widget:day'                            => 'день',
    'widget:i_agree'                        => 'Нажимая кнопку "Записаться", Вы соглашаетесь с',
    'widget:terms_conditions'               => 'условиями пользовательского соглашения',
    'widget:send'                           => 'Записаться',
    'widget:duration'                       => 'длительность',
    'widget:info'                           => 'Информация',
    'widget:contacts'                       => 'Контакты',
    'widget:phone'                          => 'Телефон',
    'widget:address'                        => 'Адрес',
    'widget:work_hours'                     => 'work_hours',

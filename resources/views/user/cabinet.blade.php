...
@section('main-content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{ trans('adminlte_lang::message.profile') }}</li>
        </ol>
    </section>
    <div class="container">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-3 col-md-3 col-xs-3">
                                    <!-- avatar -->
                                    <div class="text-left">
                                        <form id="avatar_form" method="post" action="/user/saveAvatar">
                                ...
                                <div class="col-sm-9 col-md-9 col-xs-9">
                                    <!-- inf -->
                                    <p class="form-text">{{$crmuser->name}}</p>
                                    <p class="form-text"><i class="fa fa-phone"></i>&nbsp;{{$crmuser->phone}}</p>
                                    <p class="form-text"><i class="fa fa-envelope"></i>&nbsp;{{$crmuser->email}}</p>
                                </div>
                            </div>
                            <div>
                                <a href="javascript:void(0)" class="btn btn-primary btn-boxfoot pull-right">@lang('main.user:btn_my_records')</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <form id="mailings_form" method="post" action="/user/saveMailingSettings">
                                ...
                                <div>
                                    <a href="javascript:void(0)" id="mailings_submit" class="btn btn-primary btn-boxfoot pull-right">@lang('main.btn_submit_label')</a>
                                </div>
                            </form>
                        </div>
                    </div>

                ...
                <div class="tab-pane fade in active" id="tab_user_properties">
                    <form method="post" action="/users/save" class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-right" for="usr_name">@lang('main.user:name_label')</label>
                            <div class="col-sm-9">
                                <?php
                                $old = old('name');
                                if (!is_null($old)) {
                                ...
                                <input type="text" class='form-control' class='form-control' name="name" id="usr_name" value="{{$value}}">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-right" for="usr_info">@lang('main.user:info_label')</label>
                            <div class="col-sm-9">
                                <?php
                                $old = old('info');
                                if (!is_null($old)) {
                                ...
                                <input type="text" class='form-control' name="info" id="usr_info" value="{{$value}}">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-right" for="usr_email">@lang('main.user:email_label')</label>
                            <div class="col-sm-9">
                                <?php
                                $old = old('email');
                                if (!is_null($old)) {
                                ...
                                <input type="text" class='form-control' name="email" id="usr_email" value="{{$value}}">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-right" for="usr_phone">@lang('main.user:phone_label')</label>
                            <div class="col-sm-9">
                                <?php
                                $old = old('phone');
                                if (!is_null($old)) {
                                ...
                                <input type="text" class='form-control' name="phone" id="usr_phone" value="{{$value}}">
                        ...
                        @if(!isset($crmuser))
                        <div class="form-group">
                            <label class="col-sm-3 control-label text-right" for="usr_password">@lang('main.user:password_label')</label>
                            <div class="col-sm-9">
                                <input type="text" class='form-control' name="password" id="usr_password">

...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <div class="col-sm-6">
                <a href="#detailed-services" data-toggle="collapse" class="btn btn-link link-blue">
        ...
        <div id="detailed-services" class="form-group collapse">
            <div class="wrap-it">
                <div class="col-sm-10" style="padding:0">
                    <div class="col-sm-4">
                        {{ Form::select('services_cats_detailed[]', [], null, ['class' => ' js-select-basic-single', 'maxlength' => '110']) }}
                    </div>
                    <div class="col-sm-4">
                        {{ Form::select('services_detailed[]', [], null, ['class' => ' js-select-basic-single', 'maxlength' => '110']) }}
                    </div>
                    <div class="col-sm-2">
                        {{ Form::text('services_percent_detailed[]', null, ['class' => 'form-control', 'maxlength' => '110']) }}
                    </div>
                    <div class="col-sm-2">
                        {{ Form::select('services_unit_detailed[]', ['rub' => '₽', 'pct' => '%'], 'rub', ['class' => ' js-select-basic-single', 'maxlength' => '110']) }}
                    </div>
                </div>
        ...
        <div class="form-group">
            <div class="col-sm-10">
                <div class="box box-details box-solid collapsed-box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body" >
                        <div id="detailed-products" class="form-group alt-control-bar">
                            <div class="wrap-it">
                                <div class="col-sm-10" style="padding:0">
                                    <div class="col-sm-4">
                                        {{ Form::select('products_cats_detailed[]', [], null, ['class' => ' js-select-basic-single', 'maxlength' => '110']) }}
                                    </div>
                                    <div class="col-sm-4">
                                        {{ Form::select('products_detailed[]', [], null, ['class' => ' js-select-basic-single', 'maxlength' => '110']) }}
                                    </div>
                                    <div class="col-sm-2">
                                        {{ Form::text('products_percent_detailed[]', null, ['class' => 'form-control', 'maxlength' => '110']) }}
                                    </div>
                                    <div class="col-sm-2">
                                        {{ Form::select('products_unit_detailed[]', ['rub' => '₽', 'pct' => '%'], 'rub', ['class' => ' js-select-basic-single', 'maxlength' => '110']) }}
                                    </div>
                                </div>
                                <div class="col-sm-2" style="">
                                    <button type="button" id="add-detailed-section" class="btn btn-add"><i class="fa fa-plus-circle"></i></button>
<!--                                    <input type="button" id="add-detailed-section" class="btn btn-info btn-sm" value="Добавить">-->
                                </div>
                            </div>
                        </div>

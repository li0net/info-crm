...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="col-sm-12 m-t rtext-right">
                @if ($user->hasAccessTo('wage_scheme', 'edit', 0))
                    {!! Html::linkRoute('wage_scheme.edit', trans('adminlte_lang::message.edit'), [$scheme->scheme_id], ['class'=>'btn btn-primary pull-right']) !!}
                @endif
                @if ($user->hasAccessTo('wage_scheme', 'delete', 0))
                {!! Form::open(['route' => ['wage_scheme.destroy', $scheme->scheme_id], "method" => 'DELETE', "class" => 'pull-right m-r']) !!}

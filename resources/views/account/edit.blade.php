...
@section('main-content')
	...
	<div class="row">
		<div class="col-sm-6 col-sm-offset-3">
			<h4>{{ trans('adminlte_lang::message.account_information') }}</h4>	
			<hr>	
			@if (count($errors) > 0)
			...
			<div class="well">
				...
				{!! Form::model($account, ['route' => ['account.update', $account->account_id], 'method' => 'PUT']) !!}
					<div class="form-group">
						{{ Form::label('title', trans('adminlte_lang::message.account_name'), ['class' => 'form-spacing-top']) }}
					...
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="row">
								<div class="col-sm-6">
									{!! Html::linkRoute('account.show', trans('adminlte_lang::message.cancel'), [$account->account_id], ['class'=>'btn btn-danger btn-block']) !!}
								</div>
								<div class="col-sm-6">
